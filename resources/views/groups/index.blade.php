...
{{-- WAJIB DI PALING ATAS SEBELUM KONTEN APAPUN --}}
<script>
        ...
        <div class="w-2/3 flex flex-col">
            ...
            @if($selectedUser)
                ...
                <div class="bg-blue-600 text-white p-5">
                    ...
                    <p class="text-sm opacity-80">Private Conversation</p>
                </div>
                            ...
                            <div class="flex justify-end">
                                <div class="max-w-md">
                                    <div class="bg-blue-600 text-white px-4 py-3 rounded-2xl shadow">
                                        ...
                                        @if($msg->file)
                                            <div class="mt-2">
                                                <a href="{{ asset('storage/' . $msg->file) }}" target="_blank" class="text-blue-200 underline">
                                                    📎 Lihat File
                                                </a>
                                            </div>
                                        @endif
                            ...
                            <div class="flex justify-start">
                                <div class="max-w-md">
                                    <div class="bg-white px-4 py-3 rounded-2xl shadow">
                                        ...
                                        @if($msg->file)
                                            <div class="mt-2">
                                                <a href="{{ asset('storage/' . $msg->file) }}" target="_blank" class="text-blue-600 underline">
                                                    📎 Lihat File
                                                </a>
                                            </div>
                                        @endif
                ...
                <!-- TYPING INDICATOR -->
                <div id="typing-indicator" class="px-4 py-2 text-sm text-gray-500 italic"></div>

                <!-- FORM -->
                <div class="border-t bg-white p-4">
                    <form method="POST" action="{{ route('message.store') }}" enctype="multipart/form-data" class="flex gap-3">
                        @csrf
                        ...
                        >
                        <input type="file" name="file" class="border rounded-xl p-2">
                        <button type="submit" class="bg-blue-600 text-white px-6 rounded-2xl hover:bg-blue-700">
                            Kirim
                        </button>
                    </form>
                </div>
            ...
            @else
                ...
                <div class="flex items-center justify-center h-full bg-gray-100">
                    <div class="text-center">
                        ...
                        <h2 class="text-2xl font-bold text-gray-700">Pilih User</h2>
                        <p class="text-gray-500 mt-2">Mulai percakapan private sekarang.</p>
                    </div>
                </div>
